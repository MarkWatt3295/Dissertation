...
public class NYmanagerPacketHandler implements IMessageHandler<NYmanagerMessage, IMessage> {

@Override
 public IMessage onMessage(NYmanagerMessage message, MessageContext ctx) { 
