...
public class ZmanagerPacketHandler implements IMessageHandler<ZmanagerMessage, IMessage> {

@Override
 public IMessage onMessage(ZmanagerMessage message, MessageContext ctx) { 
