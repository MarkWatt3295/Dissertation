...
public  class EntityMathsShopKeeper extends EntityCreature {
	
	public final ItemStackHandler handler;

	public EntityMathsShopKeeper(World var1) {
		super(var1);
	...
	public boolean processInteract(EntityPlayer entity, EnumHand hand) {
		...
		if (true) {
			System.out.println("Printing from Shopkeeper mob");
			 ...
			 {
		            Minecraft.getMinecraft().displayGuiScreen(new GuiMathsStore());
