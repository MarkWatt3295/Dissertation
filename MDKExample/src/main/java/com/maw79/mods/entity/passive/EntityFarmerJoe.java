...
public  class EntityFarmerJoe extends EntityCreature {
	
	public final ItemStackHandler handler;

	public EntityFarmerJoe(World var1) {
		super(var1);
	...
	public boolean processInteract(EntityPlayer entity, EnumHand hand) {
		...
		if (true) {
			System.out.println("Printing from Farmer Joe mob");
			 if (this.world.isRemote)
			 {
		            Minecraft.getMinecraft().displayGuiScreen(new GuiFarmerJoe());
