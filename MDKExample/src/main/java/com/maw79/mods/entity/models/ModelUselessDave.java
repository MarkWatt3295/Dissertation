package com.maw79.mods.entity.models;
...
public class ModelUselessDave extends ModelBase
{
    ModelRenderer head;
    ModelRenderer body;
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
  {
    ...
    this.rightarm.rotateAngleZ += MathHelper.cos(f * 0.09F) * 0.05F + 0.05F;
    this.leftarm.rotateAngleZ -= MathHelper.cos(f * 0.09F) * 0.05F + 0.05F;
    this.rightarm.rotateAngleX += MathHelper.sin(f * 0.067F) * 0.05F;
    this.leftarm.rotateAngleX -= MathHelper.sin(f * 0.067F) * 0.05F;
  }
