...
public  class EntityRomanSteve extends EntityCreature {
	World world = null;

	public EntityRomanSteve(World var1) {
		super(var1);
		world = var1;
		experienceValue = 5;
	...
	public boolean processInteract(EntityPlayer entity, EnumHand hand) {
		...
		if (true) {
			System.out.println("Printing from Shopkeeper mob");
			 ...
			 {
		            Minecraft.getMinecraft().displayGuiScreen(new GuiRomanSteve());
			 }
		        }
		return true;
	}
