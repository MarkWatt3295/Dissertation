 ...
 *
 */
public class Maw79ConfigGuiFactory implements IModGuiFactory {
	 ...
	 *
	 */
	public static class Maw79ConfigGui extends GuiConfig {
		
		/**
		 * Settting up the screen
		 * @param parentScreen The prior screen
		 */
		public Maw79ConfigGui(GuiScreen parentScreen) {
		...
		public static class CategoryEntryBlocks extends CategoryEntry {
			...
			protected GuiScreen buildChildScreen() {
				Configuration config = Maw79Config.getConfig();
				ConfigElement categoryBlocks = new ConfigElement(config.getCategory(Maw79Config.CATEGORY_NAME_BLOCKS));
