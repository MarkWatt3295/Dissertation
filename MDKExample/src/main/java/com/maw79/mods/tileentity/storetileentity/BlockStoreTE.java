...
public class BlockStoreTE extends BlockContainer implements ITileEntityProvider {
	
	/**
	 * Default constructor which sets the hardness and resistance
	 * @param unlocalizedName The unlocalized name
	 */
	public BlockStoreTE(String unlocalizedName) {
		super(Material.IRON);
		...
		if (!world.isRemote)
	        {
	            ...
	            player.openGui(Maw79Mod.instance, GuiHandler.STORE_GUI,  world, pos.getX(), pos.getY(), pos.getZ());
	        }
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		TileEntityStore te = (TileEntityStore) world.getTileEntity(pos);
