...
public class BlockRomanQuest extends BlockContainer {
	
	
	 
	public BlockRomanQuest(String unlocalizedName) {
		super(Material.IRON);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
		...
		if (!world.isRemote)
	        {
	            player.openGui(Maw79Mod.instance, GuiHandler.ROMAN_QUEST,  world, pos.getX(), pos.getY(), pos.getZ());
	        }
