...
public class BlockPropertiesMatcher extends BlockContainer {
	
	
	 
	public BlockPropertiesMatcher(String unlocalizedName) {
		super(Material.IRON);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
		...
		if (!world.isRemote)
	        {
	            player.openGui(Maw79Mod.instance, GuiHandler.PROPERTIES_MATCHER,  world, pos.getX(), pos.getY(), pos.getZ());
	        }
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityPropertiesMatcher();
	}
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		TileEntityPropertiesMatcher te = (TileEntityPropertiesMatcher) world.getTileEntity(pos);
