...
public class BlockScienceTE extends BlockContainer implements ITileEntityProvider {
	
	/**
	 * Default constructor which sets the hardness and resistance
	 * @param unlocalizedName The unlocalized name
	 */
	public BlockScienceTE(String unlocalizedName) {
		super(Material.IRON);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
		...
		if (!world.isRemote)
	        {
	            player.openGui(Maw79Mod.instance, GuiHandler.SCIENCE_GUI,  world, pos.getX(), pos.getY(), pos.getZ());
	        }
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		TileEntityScience te = (TileEntityScience) world.getTileEntity(pos);
