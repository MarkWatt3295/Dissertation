...
public abstract class BlockSteelSlab extends BlockSlab{

	public BlockSteelSlab(String unlocalizedName) {
		super(Material.IRON);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.steelSlabHalf);
	}
