...
public class BlockMathsSubtractionBlock extends Block {
	
	public boolean blockanswered;
	
	public BlockMathsSubtractionBlock(String unlocalizedName) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player,
		...
		if(!player.world.isRemote){
			...
			Minecraft.getMinecraft().displayGuiScreen(new GuiSubtractionBlock());
