...
public class BlockRecycler extends BlockContainer {
	...
	public BlockRecycler(String unlocalizedName) {
		super(Material.IRON);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
		...
		if (!world.isRemote)
	        {
	            player.openGui(Maw79Mod.instance, GuiHandler.RECYCLER_BLOCK,  world, pos.getX(), pos.getY(), pos.getZ());
	        }
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		TileEntityRecycler te = (TileEntityRecycler) world.getTileEntity(pos);
