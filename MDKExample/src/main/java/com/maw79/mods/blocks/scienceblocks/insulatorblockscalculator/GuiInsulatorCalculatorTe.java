 ...
 *
 */
public class GuiInsulatorCalculatorTe extends GuiContainer {

	/**
	 * The tile entity and player inventory
	 */
	private TileEntityInsulatorCalculator te;
	...
	public GuiInsulatorCalculatorTe(IInventory playerInv, TileEntityInsulatorCalculator te) {
		super(new ContainerInsulatorCalculator(playerInv, te));
