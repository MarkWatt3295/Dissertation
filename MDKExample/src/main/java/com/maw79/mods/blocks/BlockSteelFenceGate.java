 ...
 *
 */
public class BlockSteelFenceGate extends BlockHorizontal {
    ...
    public BlockSteelFenceGate(String unlocalizedName)
    {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        worldIn.playSound(playerIn, pos, ((Boolean)state.getValue(OPEN)).booleanValue() ? ModSoundHandler.STEEL_FENCE_GATE_OPEN : ModSoundHandler.STEEL_FENCE_GATE_CLOSE, SoundCategory.BLOCKS, 1.0F, 1.0F);
        ...
        if (!worldIn.isRemote)
        {
            ...
            if (((Boolean)state.getValue(POWERED)).booleanValue() != flag)
            {
                ...
                if (((Boolean)state.getValue(OPEN)).booleanValue() != flag)
                {
                	...
                	worldIn.playSound(null, pos, flag ? ModSoundHandler.STEEL_FENCE_GATE_OPEN : ModSoundHandler.STEEL_FENCE_GATE_CLOSE, SoundCategory.BLOCKS, 1.0F, 1.0F);
                }
            }
        }
    }
