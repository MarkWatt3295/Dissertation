...
public abstract class BlockScienceProperties extends BlockContainer implements IMetaBlockName, ITileEntityProvider {
	 ...
	 */
	public BlockScienceProperties(String unlocalizedName) {
