 ...
 *
 */
public class GuiPointsBlock extends GuiContainer {

	/**
	 * The tile entity and player inventory
	 */
	private TileEntityPointsBlock te;
	...
	public GuiPointsBlock(IInventory playerInv, TileEntityPointsBlock te) {
		super(new ContainerPointsBlock(playerInv, te));
