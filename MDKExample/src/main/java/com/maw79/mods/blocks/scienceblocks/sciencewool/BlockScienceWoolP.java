...
public class BlockScienceWoolP extends BlockScienceProperties {
	 ...
	 */
	public BlockScienceWoolP(String unlocalizedName) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(!worldIn.isRemote) {
			playerIn.openGui(Maw79Mod.instance, GuiHandler.TEST2, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
