...
public class ItemDomusScorer extends Item{
	
	public ItemDomusScorer(String unlocalizedName) {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		tooltip.add(TextFormatting.BLUE + Utils.getLang().localize("domusscorer.tooltip"));
	}
}
