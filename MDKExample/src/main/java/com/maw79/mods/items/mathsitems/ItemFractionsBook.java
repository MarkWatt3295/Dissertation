...
public class ItemFractionsBook extends Item{
	
	public ItemFractionsBook(String unlocalizedName) {
	...
	public  ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
		...
		Minecraft.getMinecraft().displayGuiScreen(new GuiFractionsBook());
		}
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		tooltip.add(TextFormatting.BLUE + Utils.getLang().localize("fractionsbook.tooltip"));
	}
}
