...
public class ItemCoordinatesManual extends Item{
	
	public ItemCoordinatesManual(String unlocalizedName) {
	...
	public  ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
		...
		Minecraft.getMinecraft().displayGuiScreen(new GuiCoordinatesManual());
		}
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		tooltip.add(TextFormatting.LIGHT_PURPLE + Utils.getLang().localize("coordinatesmanual.tooltip"));
	}
}
