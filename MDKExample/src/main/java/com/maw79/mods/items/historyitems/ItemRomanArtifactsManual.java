...
public class ItemRomanArtifactsManual extends Item{
	
	public ItemRomanArtifactsManual(String unlocalizedName) {
	...
	public  ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
		...
		Minecraft.getMinecraft().displayGuiScreen(new GuiRomanArtifactsManual());
		}
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		tooltip.add(TextFormatting.LIGHT_PURPLE + Utils.getLang().localize("romanartifactsmanual.tooltip"));
	}
}
