...
public class GuiEgyptStore extends GuiScreen {
        ...
        switch (button.id) {
            case BUTTON1:
            	...
            	if(TileEntityPointsBlock.playerScore >= 40){
            		...
            		System.out.println("Not Enough Points (for 1 - Levitation Dust 40) :( ");
            	}
            ...
            case BUTTON3:
            	...
            	if(TileEntityPointsBlock.playerScore >= 30){
            		...
            		mc.player.playSound(ModSoundHandler.MAWSOUND_ERRORNOISE, 1.0f, 1.0f);
            		System.out.println("Not Enough Points (for 3 - Jump Potion 30) :( ");
            	}
            ...
            case BUTTON4:
            	...
            	if(TileEntityPointsBlock.playerScore >= 5){
            		...
            		mc.player.playSound(ModSoundHandler.MAWSOUND_ERRORNOISE, 1.0f, 1.0f);
            		System.out.println("Not Enough Points (for 4 - Chest 5):( ");
            	}
