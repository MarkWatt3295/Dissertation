...
public class GuiMathsDivisionBlock extends GuiScreen {
	...
	double randomAnswer = rand.nextInt((int)(( divmax - divimin)+1))+divimin;
	String number ="";
	int answer = 0;
	...
	public int guiWidth = 175;
	public int guiHeight = 210;

	public String title = "Decimal Division";
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		GlStateManager.scale(2, 2, 2);
		 drawString(mc.fontRendererObj,title, 0, 0, 0x6028ff);
		...
		GlStateManager.pushMatrix();
		{
			...
			GlStateManager.scale(1.4, 1.4, 1.4);
			 ...
			 drawString(mc.fontRendererObj, String.format("%.2f", randomNum1) + " ÷ " + (String.format("%.2f", randomNum2)), (-23), (20), 0xffffff);
			 drawString(mc.fontRendererObj, String.format("%.2f", randanswer), (-23), (40), 0xffffff);
			 drawString(mc.fontRendererObj, String.format("%.2f", randanswer2), (-23), (56), 0xffffff);
			 drawString(mc.fontRendererObj, String.format("%.2f", randanswer3), (-23), (74), 0xffffff);
