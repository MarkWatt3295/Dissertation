...
public class GuiOddManual extends GuiScreen
{
	...
	public GuiOddManual()
	{
	    ...
	    String s0 = TileEntityMathsQuest.oddarray[0];
	    String s1 = TileEntityMathsQuest.oddarray[1];
	    String s2 = TileEntityMathsQuest.oddarray[2];
	    String s3 = TileEntityMathsQuest.oddarray[3];
	    String s4 = TileEntityMathsQuest.oddarray[4];
	    String s5 = TileEntityMathsQuest.oddarray[5];
	    String s6 = TileEntityMathsQuest.oddarray[6];
	    String s7 = TileEntityMathsQuest.oddarray[7];
	    String s8 = TileEntityMathsQuest.oddarray[8];
	    String s9 = TileEntityMathsQuest.oddarray[9];
	   
	    String sline1 = "Numbers Left to Find : "+"§9"+TileEntityMathsQuest.oddnumstofind +"\n"+"§0";
	    String sline2 = "§6"+s0+s1+ s2+s3+s4 +"\n"+s5+s6+s7+s8+s9;
	    String sline3 = "";
	    ...
	    stringPageText[0] = "§6"+"Odd Number Quest"+"§0"+"\n\nCan you find all of the Odd numbers between "+"§6"+ "1 "+"§0"+ "and "+"§6"+ "20 "+"§0"+"?"+ "\n\n"+"§6"+"Odd Numbers \n"+"§0"+ "An Odd number "+"§6"+ "cannot "+"§0"+ "be divided equally by 2 \n" +"§6"+"Odd Number Example \n"+"§0"+"1, 3, 5, "+"§k"+"1"+ "§0";
	    stringPageText[1] = "§6"+"How To Play"+"§0"+"\n\n\nSearch underground for Odd Number blocks.  There are "+"§6"+"10 "+"§0"+"Odd Number blocks to find. Bring the blocks to the Maths Quest Block and submit them."; 
	    stringPageText[2] = "§6"+"Number Finder"+"§0"+"\n\n"+ sline1+ "\nYou have found:\n"+ sline2 + "\n\n"+ "§2"+ sline3 ;
	}
