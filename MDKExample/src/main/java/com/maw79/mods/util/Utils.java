...
public class Utils {
	...
	public static Lang getLang() {
		if(lang == null) {
			lang = new Lang(Reference.MOD_ID); //Change Reference.MODID to whatever you feel necessary notice that when in the language file it will be what ever you put in . what you asked it for
		}
		return lang;
	}
